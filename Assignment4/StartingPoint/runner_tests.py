...
{
    "name": "Extra test: Break sensor, request water level change, fix sensor and resume",
    "input_events": [
        (0, "water_lvl", 508),
        (3019266917, "water_lvl", 99007),
        (6251202467, "request_lvl_change", None),
        (7391958498, "water_lvl", 504),
        (8599152095, "resume", None),
        (10699152095, "water_lvl", 670),
        (10799152095, "water_lvl", 812),
        (10899152095, "water_lvl", 927),
        (10999152095, "water_lvl", 1028),
        (11099152095, "water_lvl", 1104),
        (11199152095, "water_lvl", 1173),
        (11299152095, "water_lvl", 1231),
        (11399152095, "water_lvl", 1281),
        (11499152095, "water_lvl", 1316),
        (11599152095, "water_lvl", 1346),
        (11699152095, "water_lvl", 1378),
        (11799152095, "water_lvl", 1399),
        (11899152095, "water_lvl", 1414),
        (11999152095, "water_lvl", 1436),
        (12099152095, "water_lvl", 1450),
        (12199152095, "water_lvl", 1459),
        (12299152095, "water_lvl", 1469),
        (12399152095, "water_lvl", 1471),
        (12499152095, "water_lvl", 1481),
        (12599152095, "water_lvl", 1488),
        (12699152095, "water_lvl", 1490),
        (12799152095, "water_lvl", 1492),
        (12899152095, "water_lvl", 1491),
        (12999152095, "water_lvl", 1497),
        (13099152095, "water_lvl", 1501),
        (13199152095, "water_lvl", 1506),
        (13299152095, "water_lvl", 1508),
        (13399152095, "water_lvl", 1504),
    ],
    "output_events": [
        (0, "open_doors", 0),
        (0, "green_light", 0),
        (3019266917, "red_light", 0),
        (3019266917, "close_doors", 0),
        (3019266917, "set_sensor_broken", None),
        (6251202467, "set_request_pending", True),
        (10599152095, "open_flow", 1),
        (13399152095, "close_flow", 1),
        (13399152095, "set_request_pending", False),
        (13399152095, "open_doors", 1),
        (13399152095, "green_light", 1),
    ],
}
]
