...
#define MODEL_IDENTIFIER Gantry_system_block
#define MODEL_GUID "{ca22aa08-1924-4fd8-b452-1a15ca174b79}"
...
#define FMI2_FUNCTION_PREFIX Gantry_system_block_
...
extern void Gantry_system_block_setupDataStruc(DATA *data, threadData_t *threadData);
#define fmu2_model_interface_setupDataStruc Gantry_system_block_setupDataStruc
...
void setDefaultStartValues(ModelInstance *comp) {
  ...
  comp->fmuData->modelData->realParameterData[1].attribute.start = 2.0;
  comp->fmuData->modelData->realParameterData[2].attribute.start = 0.5;
  comp->fmuData->modelData->realParameterData[3].attribute.start = 9.80665;
  comp->fmuData->modelData->realParameterData[4].attribute.start = 0.2;
